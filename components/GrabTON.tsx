...
const GrabTON: React.FC = () => {
  return (
    <div className="w-full min-h-[380px] bg-gradient-to-b from-[#0a1930] to-[#1a2347] relative flex items-center justify-center px-[30px]">
      ...
      <div className="absolute top-10 left-10 text-white text-2xl animate-pulse">
        ✦
      </div>
      <div
        className="absolute top-20 right-20 text-white text-lg animate-pulse"
        style={{ animationDelay: "1s" }}
      >
        +
      </div>
      <div
        className="absolute bottom-20 left-20 text-white text-xl animate-pulse"
        style={{ animationDelay: "2s" }}
      >
        ⚙
      </div>
      <div
        className="absolute bottom-10 right-10 text-white text-lg animate-pulse"
